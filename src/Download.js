...
async function Download(Time, attribution) {
    ...
    const DataSites = await RawDataSites.then(res => res.text()).then(res => (Handlers.ParseText(res))).then(res => Handlers.ParseXMLSites(res));
...
async function DownloadWind(Time, attribution) {
    ...
    const SitesSet = await RawDataStations.then(res => res.text()).then(res => Handlers.ParseText(res)).then(res => Handlers.ParseXMLSites(res));
    const SitesSetMETAR = await RawDataStationsMETAR.then(res => res.text()).then(res => Handlers.ParseText(res)).then(res => Handlers.ParseXMLSites(res));
    const SitesSetUGMS = await RawDataStationsUGMS.then(res => res.text()).then(res => Handlers.ParseText(res)).then(res => Handlers.ParseXMLSites(res));
    ...
    /* Обработаныне данные */
    const WindSpeed = await RawDataWindSpeed.then(res => res.text()).then(res => Handlers.ParseText(res)).then(res => Handlers.ParseXMLDataForLayer(res, Time, 1));
    const WindDirection = await RawDataWindDirection.then(res => res.text()).then(res => Handlers.ParseText(res)).then(res => Handlers.ParseXMLDataForLayer(res, Time, 1));
    const WindSpeedMETAR = await RawDataWindSpeedMETAR.then(res => res.text()).then(res => Handlers.ParseText(res)).then(res => Handlers.ParseXMLDataForLayer(res, Time, 1));
    const WindDirectionMETAR = await RawDataWindDirectionMETAR.then(res => res.text()).then(res => Handlers.ParseText(res)).then(res => Handlers.ParseXMLDataForLayer(res, Time, 1));
    const WindSpeedUGMS = await RawDataWindSpeedUGMS.then(res => res.text()).then(res => Handlers.ParseText(res)).then(res => Handlers.ParseXMLDataForLayer(res, Time, 1));
    const WindDirectionUGMS = await RawDataWindDirectionUGMS.then(res => res.text()).then(res => Handlers.ParseText(res)).then(res => Handlers.ParseXMLDataForLayer(res, Time, 1));
